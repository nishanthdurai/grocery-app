...
public class CustomerSignUpActivity extends AppCompatActivity {
    ...
    private void verifyEmailExistenceAndCreateTutorAccount(String email, String password) {
        ...
        Query emailQuery = dbReference.child("customer").orderByChild("email").equalTo(email);
        emailQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    Customer customer = new Customer(email, password, id);
                    dbReference.child("customer").child(id).setValue(customer).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(CustomerSignUpActivity.this, "Error registering user, try again later..!",
